export default function ConvertIcon(props: { className?: string }) {
  return (
    <svg className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
      <defs>
        <clipPath>
          <path fill="currentColor" d="m7 1023.36h1v1h-1z" />
        </clipPath>
        <clipPath>
      ...
      <g transform="matrix(0 .01743-.01743 0 19 2.998)" fill="currentColor">
